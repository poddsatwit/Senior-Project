...
public class CardDatabase : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        cardList.Add(new Card(5, "Drawing a Blank", "Wildcard", 1, 1, "Select one player and insert a blank bullet into their gun, shuffle the bullets in their gun. Does not work if gun is full.", Resources.Load<Sprite>("")));
        cardList.Add(new Card(6, "Clairvoyance", "Wildcard", 2, 0, "See the next bullet on your gun or someone else’s.", Resources.Load<Sprite>("")));
        cardList.Add(new Card(7, "Clean Shuffle", "Wildcard", 1, 0, "Shuffle someone’s bullets or yours.", Resources.Load<Sprite>("")));
        cardList.Add(new Card(8, "True Shuffle", "Wildcard", 3, 0, "Get everyone’s bullets and shuffle them evenly across everyone’s gun.", Resources.Load<Sprite>("")));
        ...
        cardList.Add(new Card(10, "Collecting Dues", "Wildcard", 1, 0, "Take 1 bullet from someone and load it into your gun.", Resources.Load<Sprite>("")));
