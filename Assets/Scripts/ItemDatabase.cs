...
public class ItemDatabase : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        ItemList.Add(new Item(1, "Bullet", "Item", 1, 2, "Gain 1 bullet.", Resources.Load<Sprite>("") ));
        ItemList.Add(new Item(1, "Blank", "Item", 1, 2, "Use to give 1 blank bullet to someone.", Resources.Load<Sprite>("") ));
